        ...
        try {
          ...
          if (e.cause) {
            if (e.cause.name === "ConnectTimeoutError") {
              ...
              message = `The request failed with "${e.cause.name}": ${e.cause.message}. If you're having trouble setting up CodeLift, please see the troubleshooting guide for help.`;
            }
          }
          ...
          if (message.includes("https://proxy-server")) {
            ...
            if (message.includes("exceeded")) {
              message +=
                " To keep using CodeLift, you can set up a local model or use your own API key.";
            }
